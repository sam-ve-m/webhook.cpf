fission spec init
fission env create --spec --name wbh-caf-cpf-env --image nexus.sigame.com.br/fission-webhook-caf-cpf:0.1.0-1 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
